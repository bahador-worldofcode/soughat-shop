...
import { LayoutDashboard, ShoppingCart, Package, LogOut, Image as ImageIcon, BookOpen, Wallet, PiggyBank, RefreshCw, MessageSquare, Layers, Settings, Calculator, Loader2, Star, BarChart3, Users, Database, Bug, Tag } from 'lucide-react';
...
export default function AdminWrapper({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { name: 'کدهای تخفیف', href: '/admin/discounts', icon: Tag },
    ...
    { name: 'گزارش باگ‌ها', href: '/admin/bug-reports', icon: Bug },
    ...
    { name: 'مدیریت کش', href: '/admin/cache', icon: Database },

...
export default function FloatingContact() {
  ...
  return (
    <div
      ...
      dir={isEn ? 'ltr' : 'rtl'}
    >
      {/* 🔧 دکمه‌ی شناور تماس/پیامک عمداً حذف شد: طبق تصمیم بیزنسی نمی‌خواهیم
          کاربر را به سمت تماس یا پیامک ترغیب کنیم — پاسخ‌گویی فقط از طریق
          واتساپ (وب) انجام می‌شود، پس این ویجت شناور حالا فقط همان
          میان‌بر مستقیم به چت واتساپ است. */}
      <a
        href={`https://wa.me/16506712358?text=${encodeURIComponent(t('whatsapp_msg'))}`}
        target="_blank"

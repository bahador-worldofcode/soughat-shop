...
//  اصلاحِ بعدی: در حالتِ موبایل (flex-col)، والدِ آیکون به‌صورتِ پیش‌فرض
//            align-items:stretch می‌گیرد و عرضش کامل می‌شود؛ چون خودِ عکس
//            عرضِ ثابت دارد (w-40 و...) و هیچ چیزِ سنترکننده‌ای نداشت، کنارِ
//            لبه‌ی «ابتدا»ی بلاک (سمتِ راست در RTL) می‌افتاد. با mx-auto
//            روی همون دیوِ عرض‌ثابت (فقط در حالتِ موبایل، با md:mx-0 خنثی
//            می‌شود) آیکون درست وسط‌چین شد — بدونِ اینکه به چیدمانِ
//            دسکتاپ/تبلت (که از قبل درست بود) دست بزنیم.
//  اصلاحِ بعدی (فقط مانیتورِ خیلی عریض، breakpointِ 2xl به بالا): چون
//            متنِ سمتِ راست عرضِ محدود دارد (max-w) ولی ردیف تمامِ عرضِ
//            صفحه را می‌گیرد، روی مانیتورِ خیلی عریض یک فاصله‌ی خالیِ
//            بزرگ بینِ متن و آیکون می‌افتاد و آیکون کاملاً چسبیده به لبه‌ی
//            چپ می‌نشست. با یک margin-inline-end درصدی (`2xl:me-[19%]`)
//            روی همون دیوِ بیرونیِ آیکون، آیکون از لبه فاصله می‌گیرد و به
//            سمتِ وسط می‌آید — چون درصدی است، متناسب با هر عرضِ مانیتوری
//            (نه فقط ۱۹۰۲px که تست شد) دوباره خودش را تنظیم می‌کند. سایزِ
//            آیکون هم در xl/2xl کمی بزرگ‌تر شد تا فضای بیشتری از همون
//            بخشِ خالی را پر کند. breakpointِ base/md/lg دست‌نخورده ماند.
// =============================================================================
    ...
    <section className="w-full bg-gradient-to-l from-indigo-800 via-blue-800 to-blue-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-10 md:py-14 relative z-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 md:gap-10">
          ...
          <div className="flex-shrink-0 2xl:me-[19%]">
            <div className="relative w-40 h-40 md:w-52 md:h-52 lg:w-64 lg:h-64 xl:w-72 xl:h-72 2xl:w-80 2xl:h-80 mx-auto md:mx-0">
              <img

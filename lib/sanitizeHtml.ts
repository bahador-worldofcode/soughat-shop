...
//
// 🆕 رفع باگ «فهرست مطالب» (کلیک روی لینک‌های فهرست مطالب کاربر رو به بخش
// موردنظر نمی‌برد): علتش این بود که ویژگی id (که روی هر h2 گذاشته می‌شود تا
// لینک‌های #sec-1، #sec-2 و... بتوانند آن را پیدا کنند) در لیست ALLOWED_ATTR
// نبود، پس DOMPurify همیشه آن را از خروجی حذف می‌کرد و در HTML نهایی هیچ
// المانی با آن id وجود نداشت. اضافه کردن 'id' به لیست زیر این مشکل را کامل
// حل می‌کند؛ چون هنوز از طریق همین allow-list کنترل می‌شود، امنیت محتوا
// (جلوگیری از تگ/ویژگی مخرب) دست‌نخورده باقی می‌ماند.
// ==========================================================================

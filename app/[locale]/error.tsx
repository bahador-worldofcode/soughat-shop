 ...
 * نمی‌کنه، متن‌ها رو از طریق next-intl (useTranslations) می‌گیریم؛
 * این کار جواب میده چون error.tsx داخل همون NextIntlClientProvider
 * که توی layout.tsx تعریف شده رندر میشه.
 */
